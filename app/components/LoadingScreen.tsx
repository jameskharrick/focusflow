...
const steps: { key: keyof LoadingStatus; label: string; sub: string }[] = [
  {
    key: "prompts",
    label: "Crafting your scene",
    sub: "Designing your focus ambience...",
  },
  {
    key: "image",
    label: "Painting your world",
    sub: "Rendering your environment with FLUX AI...",
  },
  {
    key: "music",
    label: "Composing your music",
    sub: "Generating your soundtrack with ElevenLabs...",
  },
];
